...
${\space\space\space}$   *b*. Unzip EfficientDet D1 and Faster R-CNN models by consulting READ_ME files in folders [effdet/](https://github.com/burakulas/detocs/tree/main/effdet) and [frcnn/](https://github.com/burakulas/detocs/tree/main/frcnn)
